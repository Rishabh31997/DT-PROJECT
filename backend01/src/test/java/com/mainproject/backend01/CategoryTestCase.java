...
public class CategoryTestCase {
	...
	public void addPtoduct(){
		...
		s.getProduct().add(pro);
		s.getProduct().add(pro1);
		s.getProduct().add(pro2);
		
		cat.getProduct().add(pro);
		cat.getProduct().add(pro1);
		cat.getProduct().add(pro2);
		...
		assertTrue("Category Added Succesfully",categoryObj.addCategory(cat));
